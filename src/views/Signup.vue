      ...
      <div class="flex flex-col items-center justify-center">
        ...
        >
          ...
          <!-- <div class="mt-6 w-full">
            ...
            <input
              v-model="credentials.favoriteFood"
              aria-label="enter favorite food"
              role="input"
...
// Include favoriteFood and age in the credentials object
const credentials = ref({ email: "", password: "", favoriteFood: "", age: "" });
...
// Add a computed property to validate the form
const isFormValid = computed(() => {
  const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/; // a simple regex to validate email
  return (
